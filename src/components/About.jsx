...
import aboutImg from "../assets/img/G_1_NB1.png";
        ...
        <Row>
          ...
          <Col md={7} className="order-md-2 order-1">
            <div className="about-right">
              ...
              <div className={`about-right-wrap ${showMore ? 'h-auto' : ''}`}>
                <p dangerouslySetInnerHTML={{ __html: desc1 }} />
                <p dangerouslySetInnerHTML={{ __html: desc2 }} />
              </div>
              <button className="inlineBtn" onClick={() => handleShowMore()}>{btn} {arrowRight}</button>
            </div>
          </Col>
        </Row>
      </Container>

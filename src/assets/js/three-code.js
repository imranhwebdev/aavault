...
import Stats from "./state.module.js";
import { OrbitControls } from "./orbit.js";
import { MarchingCubes } from "./main.js";
import {
  ToonShader1,
  ToonShader2,
  ToonShaderHatching,
...
export const threeCode = () => {
  ...
  function init() {
    ...
    light = new THREE.DirectionalLight("#24D35D", 3);
    light.position.set(0.5, 0.5, 1);
    scene.add(light);

    pointLight = new THREE.PointLight("#000", 3, 0, 0);
    pointLight.position.set(0, 0, 100);
    scene.add(pointLight);

    ambientLight = new THREE.AmbientLight("#02221A", 3);
    ...
    effect.scale.set(1000, 900, 1000);
